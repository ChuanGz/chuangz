...
### Skills
[![My Skills](https://skillicons.dev/icons?i=cs,cpp,dotnet,js,ts,react,vue,azure,jenkins,grafana,kubernetes,mint,nginx,postman,docker,rails,windows,selenium,ruby,py,redis,rabbitmq,nodejs,mongodb,git&perline=7)](https://skillicons.dev)
