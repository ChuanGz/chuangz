...
| --- | --- | --- |
| Enterprise AI adoption | Governance, accountability, pilot measurement, maturity, and scale/stop decisions | [`ai-architecture`](https://github.com/ChuanGz/ai-architecture) |
| AI-assisted software delivery | Context and prompt engineering, verification, evaluation, traceability, and human-in-the-loop controls | [`ai-engineering`](https://github.com/ChuanGz/ai-engineering) |
| Agent runtime architecture | Model-agnostic contracts for agents, memory, tools, execution, orchestration, governance, and observability | [`ai-operating-system`](https://github.com/ChuanGz/ai-operating-system) |
| Grounded LLM knowledge systems | Source ingest, provenance, grounded query workflows, reusable plugins, and maintenance linting | [`ai-llm-wiki`](https://github.com/ChuanGz/ai-llm-wiki), [`mira-ai-knowledge`](https://github.com/ChuanGz/mira-ai-knowledge) |
| Applied LLM systems | Deterministic-core/probabilistic-edge design and human-reviewed assistance in a business domain | [`ai-assistant-automotive`](https://github.com/ChuanGz/ai-assistant-automotive) |
| AI-enabled product delivery | Applying AI-assisted analysis, implementation, review, testing, documentation, and operations to a logistics platform | [`logistic-ai`](https://github.com/ChuanGz/logistic-ai) |
